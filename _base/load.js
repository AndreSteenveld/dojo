// AMD module id = dojo/load
//
// This module defines onLoad detection and signaling with priority queues.
// 
define(["./kernel", "../has", "require", "./lang"], function(dojo, has, require) {
  ...
  var ready;
  if(has("loader-priority-addOnLoad")){
    ready= require.ready;
  }else{
    if(require.vendor=="dojotoolkit.org" || require.vendor=="altoviso.org"){
      ready= require.ready;
    }else{
